...
<head>
    ...
    <title>Input Tanda Tangan - Sistem Manajemen Disiplin Hakim</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu mt-4">
            ...
            <li><a href="<?= base_url("user/input_tanda_tangan") ?>" class="active"><i class="fas fa-signature"></i> Input Tanda Tangan</a></li>
    ...
    <div class="main-content">
        ...
        <nav class="navbar">
            <div>
                <h5 class="navbar-brand mb-0">Input Tanda Tangan</h5>
            </div>
            <div class="user-info">
        ...
        <div class="container-fluid">
            ...
            <!-- Form Tambah Tanda Tangan -->
            <div class="card mb-4">
                <div class="card-header">
                    <span>Tambah Data Tanda Tangan</span>
                </div>
                <div class="card-body">
                    <form method="POST" action="<?= base_url("user/input_tanda_tangan/add") ?>">
                        <div class="row mb-3">
                            <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tandaTanganTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Lokasi</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row["nip_penandatangan"]; ?></td>
                                    <td>
                                        <button type="button" class="btn btn-warning btn-action" data-bs-toggle="modal" data-bs-target="#editTandaTanganModal<?= $row["id"]; ?>">
                                            <i class="fas fa-edit"></i> Edit
                                        </button>
                                        <a href="<?= base_url("user/input_tanda_tangan/delete/" . $row["id"]) ?>" class="btn btn-danger btn-action" onclick="return confirm('Apakah Anda yakin ingin menghapus data tanda tangan ini?')">
                                        ...
                                        <div class="modal fade" id="editTandaTanganModal<?= $row["id"]; ?>" tabindex="-1" aria-labelledby="editTandaTanganModalLabel<?= $row["id"]; ?>" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="POST" action="<?= base_url("user/input_tanda_tangan/update") ?>">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nama_jabatan" class="form-label">Nama Jabatan</label>
                                                                <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" value="<?= $row["nama_jabatan"]; ?>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="nama_penandatangan" class="form-label">Nama Penandatangan</label>
                                                                <input type="text" class="form-control" id="nama_penandatangan" name="nama_penandatangan" value="<?= $row["nama_penandatangan"]; ?>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="nip_penandatangan" class="form-label">NIP Penandatangan</label>
                                                                <input type="text" class="form-control" id="nip_penandatangan" name="nip_penandatangan" value="<?= $row["nip_penandatangan"]; ?>" required>
                                                            </div>
                                                        </div>
    ...
    <div class="modal fade" id="pilihPegawaiModal" tabindex="-1" aria-labelledby="pilihPegawaiModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pilihPegawaiModalLabel">Pilih Pegawai</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="table-responsive">
                        <table id="pegawaiPilihTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Nama</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm pilih-pegawai-btn" 
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".pilih-pegawai-btn").on("click", function() {
